    ...
    <div className="flex bg-[#010409] border-b border-gray-800 overflow-x-auto flex-shrink-0 custom-scrollbar select-none">
      {tabs.map(tab => (
        <div
          ...
          className={`group flex items-center gap-2 px-4 py-2 text-sm max-w-[200px] cursor-pointer border-r border-gray-800 transition-colors ${activeTab === tab ? 'bg-[#0d1117] text-gray-200 border-t-[3px] border-t-blue-500' : 'bg-[#010409] text-gray-500 hover:bg-[#11151b] border-t-[3px] border-t-transparent'}`}
        >
