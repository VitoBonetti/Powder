    ...
    >
      ...
      <div className="px-2 mt-4 mb-2 flex-shrink-0">
        <button
          ...
          className="w-full flex items-center justify-between px-3 py-2 bg-white dark:bg-[#010409] border border-slate-300 dark:border-gray-800 rounded-md text-sm text-slate-500 dark:text-gray-400 hover:border-sky-400 dark:hover:border-blue-500 hover:text-sky-600 dark:hover:text-blue-400 transition-colors shadow-sm"
        >
          <div className="flex items-center gap-2">
            <Search className="w-4 h-4" />
            <span className="font-medium">Search Vault...</span>
          </div>
          <div className="flex items-center gap-1">
            <kbd className="bg-slate-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-[10px] font-mono border border-slate-200 dark:border-gray-700">Ctrl</kbd>
            <kbd className="bg-slate-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-[10px] font-mono border border-slate-200 dark:border-gray-700">K</kbd>
          </div>
        </button>
      </div>
